...
template<> ::cproto::GameExitAck* Arena::CreateMaybeMessage<::cproto::GameExitAck>(Arena*);
...
class GameExitAck final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:cproto.GameExitAck) */ {
 public:
